...
def display_details(home_cnf_files):
    """
    Function to display details of Tomcat installations.

    Args:
        home_cnf_files (dict): Dictionary containing details of Tomcat installations.
            Key: Tomcat identifier
            Value: List containing Tomcat home directory and configuration file path
